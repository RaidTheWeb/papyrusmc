...
public abstract class MinecraftServer implements ICommandSender, Runnable, IThreadListener, ISnooperInfo
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            PlayerProfileCache playerprofilecache = new PlayerProfileCache(gameprofilerepository, new File(universe, USER_CACHE_FILE.getName()));
            final DedicatedServer dedicatedserver = new DedicatedServer(new File(universe), DataFixesManager.createFixer(), yggdrasilauthenticationservice, minecraftsessionservice, gameprofilerepository, playerprofilecache);
        ...
        {
            LOG.fatal("Failed to start the minecraft server", exception);
        }
    }
